      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
              Join us in advancing robotics and AI research. Explore collaboration and research opportunities.
            </p>
            <Link 
              href="/positions"
        ...
        <div className="border-t border-gray-300 dark:border-gray-700 pt-8 mt-12 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-gray-600 dark:text-gray-400">
            &copy; {currentYear} <span className="font-semibold">ASPIRE Lab</span>. All rights reserved.
          </p>
